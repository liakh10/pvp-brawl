...
function memory() {
  ...
  return {
    ...
    async set(k, v, o = {}) { if (o.nx && alive(k)) return null; m.set(k, String(v)); if (o.ex) exp.set(k, Date.now() + o.ex * 1000); else exp.delete(k); return 'OK'; },
    async del(k) { const had = m.delete(k); exp.delete(k); return had ? 1 : 0; },
